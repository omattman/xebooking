<?php
// Hero News Blog Module
class DS_Custom_Hero_Blog extends ET_Builder_Module {
    function init() {
        $this->name = esc_html__( 'Blog - Hero Header', 'et_builder' );
    ...
    function shortcode_callback( $atts, $content = null, $function_name ) {
        ...
        if ( is_home() && get_query_var( 'paged' ) <= 0 ) {
            while ( have_posts() ) {
                ...
                $width = 'on' === $fullwidth ? 1080 : 1440;
                $width = (int) apply_filters( 'et_pb_blog_image_width', $width );

                $height = 'on' === $fullwidth ? 675 : 687;
                ...
                <div class="hero__container">
                    <article id="post-<?php the_ID(); ?>" <?php post_class( 'hero__inner'); ?>>
                        ...
                        <h1 class="hero__title c__black"><a href="<?php esc_url( the_permalink() ); ?>" class="f__no-und"><?php the_title(); ?></a></h1>
            ...
            if ( 'on' !== $fullwidth )
            $output = sprintf( '<div class="hero__news">%1$s</div>', $output );

            return $output;
        }
    }
}
new DS_Custom_Hero_Blog;
