...
class DS_Custom_Blog extends ET_Builder_Module {
    function init() {
        $this->name = esc_html__( 'Blog - Small Blog', 'et_builder' );
        $this->slug = 'et_pb_blog_4';
    ...
    function shortcode_callback( $atts, $content = null, $function_name ) {
        ...
        if ( have_posts() ) {
            while ( have_posts() ) {
                ...
                $width = 'on' === $fullwidth ? 1080 : 700;
                $width = (int) apply_filters( 'et_pb_blog_image_width', $width );

                $height = 'on' === $fullwidth ? 675 : 331;
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class( 'g__col blog'); ?>>
                    <?php
                        ...
                        if ( ! in_array( $post_format, array( 'link', 'audio', 'quote' ) ) ) {
                            ...
                            elseif ( '' !== $thumb && 'on' === $show_thumbnail ) :
                                if ( 'on' !== $fullwidth ) echo '<div class="post__image">'; ?>
                    ...
                    <div class="post__inner">
                        ...
                        <h3 class="post__title c__black"><a href="<?php esc_url( the_permalink() ); ?>" class="f__no-und"><?php the_title(); ?></a></h3>
