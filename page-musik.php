...
$kendte_djs_billede = get_field('kendte_djs_billede');
$bryllupsbands_billede = get_field('bryllupsbands_billede');
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post' ); ?>>
					...
					<div class="category__header-main u__hidden--sm">
						<div class="g__row">
						<?php
						if( have_rows('blandet_musik_kategori') ):
							while ( have_rows('blandet_musik_kategori') ) : the_row();
